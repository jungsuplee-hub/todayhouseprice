...
<meta property="og:url" content="http://todayhouseprice.kro.kr/apart.php">
...
<table>
    ...
    <tr>
      ...
      <th style="background: #73685d; width:20%; padding-top:15px; padding-bottom:10px;"><center><a style="font-size: 20px; color:white; text-decoration: none;" href='./apart_trend.php'>트렌트</a></center></th>
...
<table>
    <thead>
    <tr>
      <th style="background-color:rgba(255, 255, 255, 0.8); width:16%; padding-top:15px; padding-bottom:10px;"><center><a style="font-size: 20px; color:black; text-decoration: none;" href='./apart_trend.php'>거래량</a></center></th>
      <th style="background-color:rgba(0, 0, 0, 0.3); width:16%; padding-top:15px; padding-bottom:10px;"><center><a style="font-size: 20px; color:white; text-decoration: none;" href='./apart_trend_nobunyang.php'>미분양</a></center></th>
      <th style="background-color:rgba(255, 255, 255, 0.8); width:17%; padding-top:15px; padding-bottom:10px;"><center><a style="font-size: 20px; color:black; text-decoration: none;" href='./apart_trend_apart_meme.php'>매매 수급동향</a></center></th>
      <th style="background-color:rgba(255, 255, 255, 0.8); width:17%; padding-top:15px; padding-bottom:10px;"><center><a style="font-size: 20px; color:black; text-decoration: none;" href='./apart_trend_apart_rent.php'>전세 수급동향</a></center></th>
      <th style="background-color:rgba(255, 255, 255, 0.8); width:17%; padding-top:15px; padding-bottom:10px;"><center><a style="font-size: 20px; color:black; text-decoration: none;" href='./apart_trend_apart_price.php'>매매 가격지수</a></center></th>
...
<br>
<br>
<span style="font-size:30px;">최근4년 전국 아파트 미분양 그래프</span>
<br>
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var lineChartOptions = {
            ...
            vAxes: {
                0: {
                    viewWindow: { min: 0, max: <?=$row_min_max['temp_max']?> }
                }
            },
...
<table>
    <thead>
    <tr>
        <th style="font-size: 15px;">조사날짜</th>
    ...
    <tbody>
      ...
      <tr>
          <td style="font-size: 15px;"><b><?=$row['yyyymm']?></b></td>

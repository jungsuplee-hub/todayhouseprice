...
<table>
    ...
    <tbody>
      ...
      <tr>
          ...
          <?php
          if ( $row['STATUS']== '신고가') {
            echo "<td style='background-color:rgba(0, 255, 0, 0.7); font-size: 20px; width:14%;'><b>$row[price]억</b><br><br>신고가</td>";
          } elseif ( $row['STATUS']== '상승') {
            echo "<td style='background-color:rgba(0, 255, 0, 0.4); font-size: 20px; width:14%;'><b>$row[price]억</b><br><br>상승</td>";
          } elseif ( $row['STATUS']== '동일') {
            echo "<td style='background-color:rgba(255, 255, 0, 0.5); font-size: 20px; width:14%;'><b>$row[price]억</b><br><br>동일</td>";
          } elseif ( $row['STATUS']== '하락') {
            echo "<td style='background-color:rgba(255, 0, 0, 0.4); font-size: 20px; width:14%;'><b>$row[price]억</b><br><br>하락</td>";
          } elseif ( $row['STATUS']== '신저가') {
            echo "<td style='background-color:rgba(255, 0, 0, 0.7); font-size: 20px; width:14%;'><b>$row[price]억</b><br><br>신저가</td>";
          } else
          {
            echo "<td style='font-size: 20px; width:14%;'><b>$row[price]억</b><br><br>신규</td>";
          }
          ?>
          <td style="font-size: 20px; width:19%;"><b><?=$row['last_price']?>억</b><br><?=$row['last_price_date']?><br><br><?php if(strpos($row[price_last], '-') !== false) { echo "<span style='color:red;'>최근대비<br><b>"; echo abs($row['price_last']); echo "억</b>"; if($isMobile == "Y") { echo "<br>"; }else{echo ", ";} echo abs($row['percent']); echo "%하락</span>";} else{ echo "<span style='color:green;'>최근대비<br><b>"; echo abs($row['price_last']); echo "억</b>"; if($isMobile == "Y") { echo "<br>"; }else{echo ", ";} echo abs($row['percent']); echo "%상승</span>"; } ?></td>
          <td style="font-size: 20px; width:19%;"><b><?=$row['max_price']?>억</b><br><?=$row['max_price_date']?><br><br><?php if(strpos($row[price_max], '-') !== false) { echo "<span style='color:red;'>최고대비<br><b>"; echo abs($row['price_max']); echo "억</b>"; if($isMobile == "Y") { echo "<br>"; }else{echo ", ";} echo abs($row['max_percent']); echo "%하락</span>";} else{ echo "<span style='color:green;'>최고대비<br><b>"; echo abs($row['price_max']); echo "억</b>"; if($isMobile == "Y") { echo "<br>"; }else{echo ", ";} echo abs($row['max_percent']); echo "%상승</span>"; } ?></td>
    ...
    <tbody>
      ...
      <tr>
          ...
          if ( $row_rent['STATUS']== '신고가') {
            echo "<td style='background-color:rgba(0, 255, 0, 0.7); font-size: 20px; width:14%;'><b>$row_rent[rent_price]억</b><br><br>신고가</td>";
          } elseif ( $row_rent['STATUS']== '상승') {
            echo "<td style='background-color:rgba(0, 255, 0, 0.4); font-size: 20px; width:14%;'><b>$row_rent[rent_price]억</b><br><br>상승</td>";
          } elseif ( $row_rent['STATUS']== '동일') {
            echo "<td style='background-color:rgba(255, 255, 0, 0.5); font-size: 20px; width:14%;'><b>$row_rent[rent_price]억</b><br><br>동일</td>";
          } elseif ( $row_rent['STATUS']== '하락') {
            echo "<td style='background-color:rgba(255, 0, 0, 0.4); font-size: 20px; width:14%;'><b>$row_rent[rent_price]억</b><br><br>하락</td>";
          } elseif ( $row_rent['STATUS']== '신저가') {
            echo "<td style='background-color:rgba(255, 0, 0, 0.7); font-size: 20px; width:14%;'><b>$row_rent[rent_price]억</b><br><br>신저가</td>";
          } else
          {
            echo "<td style='font-size: 20px; width:14%;'><b>$row_rent[rent_price]억</b><br><br>신규</td>";
          }
          ?>
          <td style="font-size: 20px; width:19%;"><b><?=$row_rent['last_price']?>억</b><br><?=$row_rent['last_price_date']?><br><br><?php if(strpos($row_rent[price_last], '-') !== false) { echo "<span style='color:red;'>최근대비<br><b>"; echo abs($row_rent['price_last']); echo "억</b>"; if($isMobile == "Y") { echo "<br>"; }else{echo ", ";} echo abs($row_rent['percent']); echo "%하락</span>";} else{ echo "<span style='color:green;'>최근대비<br><b>"; echo abs($row_rent['price_last']); echo "억</b>"; if($isMobile == "Y") { echo "<br>"; }else{echo ", ";} echo abs($row_rent['percent']); echo "%상승</span>"; } ?></td>
          <td style="font-size: 20px; width:19%;"><b><?=$row_rent['max_price']?>억</b><br><?=$row_rent['max_price_date']?><br><br><?php if(strpos($row_rent[price_max], '-') !== false) { echo "<span style='color:red;'>최고대비<br><b>"; echo abs($row_rent['price_max']); echo "억</b>"; if($isMobile == "Y") { echo "<br>"; }else{echo ", ";} echo abs($row_rent['max_percent']); echo "%하락</span>";} else{ echo "<span style='color:green;'>최고대비<br><b>"; echo abs($row_rent['price_max']); echo "억</b>"; if($isMobile == "Y") { echo "<br>"; }else{echo ", ";} echo abs($row_rent['max_percent']); echo "%상승</span>"; } ?></td>
      </tr>
      <?php } ?>
    </tbody>
</table>

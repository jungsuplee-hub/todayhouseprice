...
where yyyymm not like '2000%'
and yyyymm not like '2001%'
and yyyymm not like '2002%'
and yyyymm not like '2003%'
and yyyymm not like '2004%'
and yyyymm not like '2005%'
and yyyymm not like '2006%'
group by yyyymm
order by yyyymm
";
...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var lineChartOptions = {
            title: '수출/수입/무역수지 추이',
            chartArea: {left: '8%', width: '85%', height:'72%'},
            seriesType: "bars",
...
$sql_min_max2 = "
select
min(total/10000)-1000 as temp_min, max(total/10000)+1000 as temp_max
FROM
(
select
left(yyyymm,4) as year,

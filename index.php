...
<meta property="og:description" content="오늘집값 - 아파트 실거래 정보를 쉽게 확인하세요">
<meta property="og:image" content="./todayhouseprice2.png">
<meta property="og:url" content="http://todayhouseprice.kro.kr/">

</head>
<body>
<!--<iframe frameborder="0" scrolling="yes" marginwidth="0" marginheight="0" width="100%" height="100%"  src="./apart_today.php" target_frame="main"></iframe>-->
		<script>
			location.href='http://todayhouseprice.kro.kr/apart_today.php'; // main.php
		</script>
</body>
</html>

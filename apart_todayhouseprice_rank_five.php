...
<h2><?=$area_main_name?> 지역별 국평(85㎡, 100세대 이상) 평균가격 Top 100</h2>
...
<table>
    <thead>
    <tr>
      <th style="font-size: 25px;"><b>순위</b></th>
      <th style="font-size: 25px;"><b>지역</th>
      <th style="font-size: 25px;"><b>평균가(억)</b></th>
      <th style="font-size: 25px;"><b>집계대상<br>아파트수</b></th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="font-size: 25px;"><b><?=$row['total_avg']?>억</b></td>
        <td style="font-size: 25px;"><b><?=$row['total_cnt']?>개</b></td>
      </tr>
      <?php } ?>
    </tbody>
</table>

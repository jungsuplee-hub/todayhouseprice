...
$bg_color1 = "background-color:rgba(0, 255, 0, 0.7);";
$bg_color2 = "background-color:rgba(0, 255, 0, 0.4);";
$bg_color3 = "background-color:rgba(255, 255, 0, 0.5);";
$bg_color4 = "background-color:rgba(255, 0, 0, 0.4);";
$bg_color5 = "background-color:rgba(255, 0, 0, 0.7);";
...
window.onload=function(){
  showResult(document.getElementById("search").value);
}
...
<?php if($isMobile=='Y'){?>
<input id="search" type="search" size="30" style="font-size:30px; border-radius: 15px; border-color:#73685d; outline: none; padding-bottom: 5px; padding-top: 8px; padding-left: 20px;" placeholder="아파트명,주소 검색,  최대 10개" onkeyup="showResult(this.value)" autofocus autocomplete="off">
<?php }else{?>
<input id="search" type="search" size="40" style="font-size:30px; border-radius: 15px; border-color:#73685d; outline: none; padding-bottom: 5px; padding-top: 8px; padding-left: 20px;" placeholder="아파트명,주소 검색,  최대 10개" onkeyup="showResult(this.value)" autofocus autocomplete="off">
<?php }?>
</form>
</center>
<br>
...
<table>
    ...
    <tr>
      <?php if($isMobile == "Y") { ?>
        <th style="font-size: 20px; background: #FF0000; width:34%;"><b>아파트명<br>거래일자</b></th>
        <th style="font-size: 20px; background: #FF0000; width:14%;"><b>전용면적</b><br>층<br>거래유형<br>(계약갱신)</b></th>
        <th style="font-size: 20px; background: #FF0000; width:18%;"><b>신규가격<br>최근대비<br>하락/상승</b></th>
        <th style="font-size: 20px; background: #FF0000; width:17%;"><b>최고대비<br>하락/<br>상승</b></th>
        <th style="font-size: 20px; background: #FF0000; width:17%;"><b>최근가격<br>최고가격</b></th>
      <?php } else{ ?>
        <th style="font-size: 20px; background: #FF0000; width:35%;"><b>아파트명<br>거래일자</b></th>
        <th style="font-size: 20px; background: #FF0000; width:14%;"><b>전용면적</b><br>층<br>거래유형<br>(계약갱신)</b></th>
        <th style="font-size: 20px; background: #FF0000; width:12%;"><b>신규가격<br>최근대비<br>하락/상승</b></th>
        <th style="font-size: 20px; background: #FF0000; width:13%;"><b>최고대비<br>하락/상승</b></th>
      ...
      <tr>
        <?php if($isMobile == "Y") { ?>
          ...
          if ( $row_favorite['STATUS']== '신고가') {
            echo "<td style='background-color:rgba(0, 255, 0, 0.7); font-size: 20px; width:18%;'><b>$row_favorite[price]억</b><br>최근대비<br>$row_favorite[price_last]억<br>$row_favorite[percent]%상승<br>신고가</td>";
          } elseif ( $row_favorite['STATUS']== '상승') {
            echo "<td style='background-color:rgba(0, 255, 0, 0.4); font-size: 20px; width:18%;'><b>$row_favorite[price]억</b><br>최근대비<br>$row_favorite[price_last]억<br>$row_favorite[percent]%상승</td>";
          } elseif ( $row_favorite['STATUS']== '동일') {
            echo "<td style='background-color:rgba(255, 255, 0, 0.5); font-size: 20px; width:18%;'><b>$row_favorite[price]억</b><br>최근대비<br>$row_favorite[price_last]억<br>$row_favorite[percent]%<br>동일</td>";
          } elseif ( $row_favorite['STATUS']== '하락') {
            echo "<td style='background-color:rgba(255, 0, 0, 0.4); font-size: 20px; width:18%;'><b>$row_favorite[price]억</b><br>최근대비<br>$row_favorite[price_last]억<br>$row_favorite[percent]%하락</td>";
          } elseif ( $row_favorite['STATUS']== '신저가') {
            echo "<td style='background-color:rgba(255, 0, 0, 0.7); font-size: 20px; width:18%;'><b>$row_favorite[price]억</b><br>최근대비<br>$row_favorite[price_last]억<br>$row_favorite[percent]%하락<br>신저가</td>";
          } else
          {
            echo "<td style='font-size: 20px; width:18%;'><b>$row_favorite[price]억</b><br>$row_favorite[price_last]억<br>신규</td>";
          }
          ?>
          <td style="background-color:rgba(150, 75, 0, 0.2); font-size: 20px; width:17%;"><b><?=$row_favorite['price_max']?>억<br><?php if($row_favorite['max_percent']>=30){ echo "<span style='color:red;'>최고가대비<br>"; echo $row_favorite['max_percent']; echo "%하락</span>";} elseif($row_favorite['max_percent']<0){ echo "<span style='color:green;'>최고가 대비<br>"; echo abs($row_favorite['max_percent']); echo "%상승</span>";} else{ echo "최고가 대비<br>"; echo $row_favorite['max_percent']; echo "%하락";} ?></b></td>
          <td style="background-color:rgba(150, 75, 0, 0.2); font-size: 20px; width:17%;"><b><?=$row_favorite['last_price']?>억</b><br>(<?=$row_favorite['last_price_date']?>)<br><b><?=$row_favorite['max_price']?>억</b><br>(<?=$row_favorite['max_price_date']?>)</td>
        <?php } else{ ?>
          ...
          if ( $row_favorite['STATUS']== '신고가') {
            echo "<td style='background-color:rgba(0, 255, 0, 0.7); font-size: 20px; width:12%;'><b>$row_favorite[price]억</b><br>최근대비<br>$row_favorite[price_last]억<br>$row_favorite[percent]% 상승<br>신고가</td>";
          } elseif ( $row_favorite['STATUS']== '상승') {
            echo "<td style='background-color:rgba(0, 255, 0, 0.4); font-size: 20px; width:12%;'><b>$row_favorite[price]억</b><br>최근대비<br>$row_favorite[price_last]억<br>$row_favorite[percent]% 상승</td>";
          } elseif ( $row_favorite['STATUS']== '동일') {
            echo "<td style='background-color:rgba(255, 255, 0, 0.5); font-size: 20px; width:12%;'><b>$row_favorite[price]억</b><br>최근대비<br>$row_favorite[price_last]억<br>$row_favorite[percent]%<br>동일</td>";
          } elseif ( $row_favorite['STATUS']== '하락') {
            echo "<td style='background-color:rgba(255, 0, 0, 0.4); font-size: 20px; width:12%;'><b>$row_favorite[price]억</b><br>최근대비<br>$row_favorite[price_last]억<br>$row_favorite[percent]% 하락</td>";
          } elseif ( $row_favorite['STATUS']== '신저가') {
            echo "<td style='background-color:rgba(255, 0, 0, 0.7); font-size: 20px; width:12%;'><b>$row_favorite[price]억</b><br>최근대비<br>$row_favorite[price_last]억<br>$row_favorite[percent]% 하락<br>신저가</td>";
          } else
          {
      ...
      <tr>
        <?php if($isMobile == "Y") { ?>
          ...
          if ( $row_favorite_rent['STATUS']== '신고가') {
            echo "<td style='background-color:rgba(0, 255, 0, 0.7); font-size: 20px; width:18%;'><b>$row_favorite_rent[rent_price]억</b><br>최근대비<br>$row_favorite_rent[price_last]억<br>$row_favorite_rent[percent]%상승<br>신고가</td>";
          } elseif ( $row_favorite_rent['STATUS']== '상승') {
            echo "<td style='background-color:rgba(0, 255, 0, 0.4); font-size: 20px; width:18%;'><b>$row_favorite_rent[rent_price]억</b><br>최근대비<br>$row_favorite_rent[price_last]억<br>$row_favorite_rent[percent]%상승</td>";
          } elseif ( $row_favorite_rent['STATUS']== '동일') {
            echo "<td style='background-color:rgba(255, 255, 0, 0.5); font-size: 20px; width:18%;'><b>$row_favorite_rent[rent_price]억</b><br>최근대비<br>$row_favorite_rent[price_last]억<br>$row_favorite_rent[percent]%<br>동일</td>";
          } elseif ( $row_favorite_rent['STATUS']== '하락') {
            echo "<td style='background-color:rgba(255, 0, 0, 0.4); font-size: 20px; width:18%;'><b>$row_favorite_rent[rent_price]억</b><br>최근대비<br>$row_favorite_rent[price_last]억<br>$row_favorite_rent[percent]%하락</td>";
          } elseif ( $row_favorite_rent['STATUS']== '신저가') {
            echo "<td style='background-color:rgba(255, 0, 0, 0.7); font-size: 20px; width:18%;'><b>$row_favorite_rent[rent_price]억</b><br>최근대비<br>$row_favorite_rent[price_last]억<br>$row_favorite_rent[percent]%하락<br>신저가</td>";
          } else
          {
            echo "<td style='font-size: 20px; width:18%;'><b>$row_favorite_rent[rent_price]억</b><br>$row_favorite_rent[price_last]억<br>신규</td>";
          }
          ?>
          <td style="background-color:rgba(80, 188, 223, 0.2); font-size: 20px; width:17%;"><b><?=$row_favorite_rent['price_max']?>억<br><?php if($row_favorite_rent['max_percent']>=30){ echo "<span style='color:red;'>최고가대비<br>"; echo $row_favorite_rent['max_percent']; echo "%하락</span>";} elseif($row_favorite_rent['max_percent']<0){ echo "<span style='color:green;'>최고가 대비<br>"; echo abs($row_favorite_rent['max_percent']); echo "%상승</span>";} else{ echo "최고가 대비<br>"; echo $row_favorite_rent['max_percent']; echo "%하락";} ?></b></td>
          <td style="background-color:rgba(80, 188, 223, 0.2); font-size: 20px; width:17%;"><b><?=$row_favorite_rent['last_price']?>억</b><br>(<?=$row_favorite['last_price_date']?>)<br><b><?=$row_favorite_rent['max_price']?>억</b><br>(<?=$row_favorite['max_price_date']?>)</td>
        <?php } else{ ?>
          ...
          if ( $row_favorite_rent['STATUS']== '신고가') {
            echo "<td style='background-color:rgba(0, 255, 0, 0.7); font-size: 20px; width:12%;'><b>$row_favorite_rent[rent_price]억</b><br>최근대비<br>$row_favorite_rent[price_last]억<br>$row_favorite_rent[percent]% 상승<br>신고가</td>";
          } elseif ( $row_favorite_rent['STATUS']== '상승') {
            echo "<td style='background-color:rgba(0, 255, 0, 0.4); font-size: 20px; width:12%;'><b>$row_favorite_rent[rent_price]억</b><br>최근대비<br>$row_favorite_rent[price_last]억<br>$row_favorite_rent[percent]% 상승</td>";
          } elseif ( $row_favorite_rent['STATUS']== '동일') {
            echo "<td style='background-color:rgba(255, 255, 0, 0.5); font-size: 20px; width:12%;'><b>$row_favorite_rent[rent_price]억</b><br>최근대비<br>$row_favorite_rent[price_last]억<br>$row_favorite_rent[percent]%<br>동일</td>";
          } elseif ( $row_favorite_rent['STATUS']== '하락') {
            echo "<td style='background-color:rgba(255, 0, 0, 0.4); font-size: 20px; width:12%;'><b>$row_favorite_rent[rent_price]억</b><br>최근대비<br>$row_favorite_rent[price_last]억<br>$row_favorite_rent[percent]% 하락</td>";
          } elseif ( $row_favorite_rent['STATUS']== '신저가') {
            echo "<td style='background-color:rgba(255, 0, 0, 0.7); font-size: 20px; width:12%;'><b>$row_favorite_rent[rent_price]억</b><br>최근대비<br>$row_favorite_rent[price_last]억<br>$row_favorite_rent[percent]% 하락<br>신저가</td>";
          } else
          {
...
<table>
    <thead>
    <tr>
        <th style="font-size: 20px; width:34%;"><b>아파트명<br>거래일자</b></th>
        <th style="font-size: 20px; width:14%;"><b>전용면적</b><br>층<br>거래유형</b></th>
        <th style="font-size: 20px; width:14%;"><b>신규<?php if($isMobile == "Y") { echo "<br>";} ?>가격<b></th>
        <th style="font-size: 20px; width:19%;"><b>최근가격</b></th>
        <th style="font-size: 20px; width:19%;"><b>최고가격</b></th>
    </tr>
    </thead>
    <tbody>
      ...
      <tr>
          ...
          <?php
          if ( $row['STATUS']== '신고가') {
            echo "<td style='background-color:rgba(0, 255, 0, 0.7); font-size: 20px; width:14%;'><b>$row[price]억</b><br>신고가</td>";
          } elseif ( $row['STATUS']== '상승') {
            echo "<td style='background-color:rgba(0, 255, 0, 0.4); font-size: 20px; width:14%;'><b>$row[price]억</b><br>상승</td>";
          } elseif ( $row['STATUS']== '동일') {
            echo "<td style='background-color:rgba(255, 255, 0, 0.5); font-size: 20px; width:14%;'><b>$row[price]억</b><br>동일</td>";
          } elseif ( $row['STATUS']== '하락') {
            echo "<td style='background-color:rgba(255, 0, 0, 0.4); font-size: 20px; width:14%;'><b>$row[price]억</b><br>하락</td>";
          } elseif ( $row['STATUS']== '신저가') {
            echo "<td style='background-color:rgba(255, 0, 0, 0.7); font-size: 20px; width:14%;'><b>$row[price]억</b><br>신저가</td>";
          } else
          {
            echo "<td style='font-size: 20px; width:14%;'><b>$row[price]억</b><br>$row[price_last]억<br>신규</td>";
          }
          ?>
          <td style="font-size: 20px; width:19%;"><b><?=$row['last_price']?>억</b><br><?=$row['last_price_date']?><br><br><?php if(strpos($row[price_last], '-') !== false) { echo "<span style='color:red;'>최근대비<br>"; echo abs($row['price_last']); echo "억"; if($isMobile == "Y") { echo "<br>"; }else{echo ", ";} echo abs($row['percent']); echo "%하락</span>";} else{ echo "<span style='color:green;'>최근대비<br>"; echo abs($row['price_last']); echo "억"; if($isMobile == "Y") { echo "<br>"; }else{echo ", ";} echo abs($row['percent']); echo "%상승</span>"; } ?></td>
          <td style="font-size: 20px; width:19%;"><b><?=$row['max_price']?>억</b><br><?=$row['max_price_date']?><br><br><?php if(strpos($row[price_max], '-') !== false) { echo "<span style='color:red;'>최고대비<br>"; echo abs($row['price_max']); echo "억"; if($isMobile == "Y") { echo "<br>"; }else{echo ", ";} echo abs($row['max_percent']); echo "%하락</span>";} else{ echo "<span style='color:green;'>최고대비<br>"; echo abs($row['price_max']); echo "억"; if($isMobile == "Y") { echo "<br>"; }else{echo ", ";} echo abs($row['max_percent']); echo "%상승</span>"; } ?></td>
...
<table>
    <thead>
    <tr>
        <th style="font-size: 20px; background: #809EAD; width:34%;"><b>아파트명<br>거래일자</b></th>
        <th style="font-size: 20px; background: #809EAD; width:14%;"><b>전용면적</b><br>층<br>거래유형</b></th>
        <th style="font-size: 20px; background: #809EAD; width:14%;"><b>신규<?php if($isMobile == "Y") { echo "<br>";} ?>가격<b></th>
        <th style="font-size: 20px; background: #809EAD; width:19%;"><b>최근가격</b></th>
        <th style="font-size: 20px; background: #809EAD; width:19%;"><b>최고가격</b></th>
    </tr>
    </thead>
    <tbody>
      ...
      <tr>
          ...
          if ( $row_rent['STATUS']== '신고가') {
            echo "<td style='background-color:rgba(0, 255, 0, 0.7); font-size: 20px; width:14%;'><b>$row_rent[rent_price]억</b><br>신고가</td>";
          } elseif ( $row_rent['STATUS']== '상승') {
            echo "<td style='background-color:rgba(0, 255, 0, 0.4); font-size: 20px; width:14%;'><b>$row_rent[rent_price]억</b><br>상승</td>";
          } elseif ( $row_rent['STATUS']== '동일') {
            echo "<td style='background-color:rgba(255, 255, 0, 0.5); font-size: 20px; width:14%;'><b>$row_rent[rent_price]억</b><br>동일</td>";
          } elseif ( $row_rent['STATUS']== '하락') {
            echo "<td style='background-color:rgba(255, 0, 0, 0.4); font-size: 20px; width:14%;'><b>$row_rent[rent_price]억</b><br>하락</td>";
          } elseif ( $row_rent['STATUS']== '신저가') {
            echo "<td style='background-color:rgba(255, 0, 0, 0.7); font-size: 20px; width:14%;'><b>$row_rent[rent_price]억</b><br>신저가</td>";
          } else
          {
            echo "<td style='font-size: 20px; width:14%;'><b>$row_rent[rent_price]억</b><br>$row_rent[price_last]억<br>신규</td>";
          }
          ?>
          <td style="font-size: 20px; width:19%;"><b><?=$row_rent['last_price']?>억</b><br><?=$row_rent['last_price_date']?><br><br><?php if(strpos($row_rent[price_last], '-') !== false) { echo "<span style='color:red;'>최근대비<br>"; echo abs($row_rent['price_last']); echo "억"; if($isMobile == "Y") { echo "<br>"; }else{echo ", ";} echo abs($row_rent['percent']); echo "%하락</span>";} else{ echo "<span style='color:green;'>최근대비<br>"; echo abs($row_rent['price_last']); echo "억"; if($isMobile == "Y") { echo "<br>"; }else{echo ", ";} echo abs($row_rent['percent']); echo "%상승</span>"; } ?></td>
          <td style="font-size: 20px; width:19%;"><b><?=$row_rent['max_price']?>억</b><br><?=$row_rent['max_price_date']?><br><br><?php if(strpos($row_rent[price_max], '-') !== false) { echo "<span style='color:red;'>최고대비<br>"; echo abs($row_rent['price_max']); echo "억"; if($isMobile == "Y") { echo "<br>"; }else{echo ", ";} echo abs($row_rent['max_percent']); echo "%하락</span>";} else{ echo "<span style='color:green;'>최고대비<br>"; echo abs($row_rent['price_max']); echo "억"; if($isMobile == "Y") { echo "<br>"; }else{echo ", ";} echo abs($row_rent['max_percent']); echo "%상승</span>"; } ?></td>
      </tr>
      <?php } ?>
    </tbody>
</table>

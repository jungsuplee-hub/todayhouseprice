...
<table>
    <thead>
    <tr>
        <th style="font-size: 20px; width:7%;"><b>순위</b></th>
        <th style="font-size: 20px; width:30%;"><b>아파트명<br>지역</b></th>
        <th style="font-size: 20px; width:14%;"><b>전용면적</b></th>
        <th style="font-size: 20px; width:15%;"><b>하락금액<br>하락률</b></th>
        <th style="font-size: 20px; width:17%;"><b>최고가격</b></th>
        <th style="font-size: 20px; width:17%;"><b>마지막<br>거래가격</b></th>
    ...
    <tbody>
      ...
      <tr>
          <td style="font-size: 30px; width:7%;"><b><?=$add_count?></b></td>
          <td style="font-size: 20px; width:30%;"><a href='./apart.php?area_main_name=<?=$row[area_main_name]?>&apart_name=<?=$row[apart_name]?>&size=<?=$row[size]?>&dong=<?=$row[dong]?>&all_area=N'><b><?=$row['apart_name']?></b><br><?=$row['area_name']?> <?=$row['dong']?></td>
          <td style="font-size: 20px; width:14%;"><b><?=$row['size']?>㎡</b></td>
          <td style="font-size: 20px; width:15%;"><b>-<?=$row['diff_price']?>억<br><?php if($row['diff_rate']>50){ echo "<span style='color:fuchsia;'>"; }else if($row['diff_rate']>30){ echo "<span style='color:red;'>"; } ?><?=$row['diff_rate']?>%<?php if($row['diff_rate']>30){ echo "</span>"; } ?></b></td>
          <td style="font-size: 20px; width:17%;"><b><?=$row['max_price']?>억</b><br><?=$row['max_price_date']?></td>
          <td style="font-size: 20px; width:17%;"><b><?=$row['last_price']?>억</b><br><?=$row['last_price_date']?></td>
      </tr>
      <?php } ?>
    </tbody>
</table>

...
<input style="width:22px; height:22px;" type="checkbox" id="email" onclick="email(this)" <?php if($email_yn=="Y"){ echo "checked";}?>><span style="font-size:25px;"><b> (구독하시면 매일아침 신규거래건을 메일로 보내드립니다.) </b></span>

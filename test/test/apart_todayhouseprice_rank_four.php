...
<br>. 100세대 이상을 기준으로 하였으며, 국토부 아파트상세정보와 매칭이 안되 누락되는 케이스가 존재할 수 있습니다.
</span>
<br><br>
...
<table>
    ...
    <tr>
        ...
        <th style="font-size: 20px; width:36%;"><b>아파트명<br>지역</b></th>
        <th style="font-size: 20px; width:17%;"><b>전용면적</b></th>
        <!--<th style="font-size: 20px; width:15%;"><b>하락금액<br>하락률</b></th>-->
        <th style="font-size: 20px; width:15%;"><b>최저가격</b></th>
        <th style="font-size: 20px; width:15%;"><b>거래일자</b></th>
        <th style="font-size: 20px; width:10%;"><b>세대수<br>건축년도</b></th>

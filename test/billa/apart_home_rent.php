...
<title>오늘집값 - 빌라 전세 상세 조회</title>
<meta name="description" content="빌라 매매, 전세 실거래가를 확인해보세요. 당일 등록된 매매/전세정보를 확인하고 본인만의 즐겨찾기를 설정 할 수 있습니다.">
<meta property="og:type" content="website">
<meta property="og:title" content="오늘집값 - 빌라전세 상세검색">
<meta property="og:description" content="오늘집값 - 빌라전세 정보를 상세히 검색 할 수 있습니다.">
...
if($area_sub_name!=''){
  $sql = "
        select
          ...
          from molit_max_min_rent_all_billa_group rent LEFT join molit_max_min_all_billa_group meme
...
<table>
    ...
    <tr>
      ...
      <th style="background: #DEEBF7; width:25%; font-size: 30px; padding-top:5px; padding-bottom:0px;"><center><a style="text-decoration: none;" href='../officetel/apart_home_rent.php?area_main_name=<?=$area_main_name?>&area_sub_name=<?=$area_sub_name?>&dong=<?=$dong?>&apart_name=<?=$apart_name?>&orderby=<?=$orderby?>'>오피스텔</a></center></th>

...
<title>오늘집값 - 빌라 랭킹(최고금액대비 하락가격 Top 100)</title>
...
last_price,
last_price_date
from molit_max_min_all_billa_group meme
...
<table>
    ...
    <tr>
      ...
      <th style="background: #DEEBF7; width:25%; font-size: 30px; padding-top:5px; padding-bottom:0px;"><center><a style="text-decoration: none;" href='../officetel/apart_todayhouseprice_rank_two.php'>오피스텔</a></center></th>
...
<h1><?=$area_main_name?> 빌라 최고금액 대비 마지막거래 가격 하락률 Top 100 </h1>
...
<table>
    ...
    <tr>
        ...
        <th style="font-size: 20px; width:40%;"><b>빌라명<br>지역</b></th>

...
<table>
    <thead>
    <tr>
      <th style="background: #FBE5D6; width:25%; font-size: 30px; padding-top:5px; padding-bottom:0px;"><center><a style="text-decoration: none;" href='../apart_trend.php'>아파트</a></center></th>
      <th style="background: #DEEBF7; width:25%; font-size: 30px; padding-top:5px; padding-bottom:0px;"><center><a style="text-decoration: none;" href='../officetel/apart_trend.php'>오피스텔</a></center></th>
...
<table>
    ...
    <tr>
      ...
      <th style="background: #73685d; width:16%; padding-top:15px; padding-bottom:10px;"><center><a style="font-size: 20px; color:white; text-decoration: none;" href='./apart_trend.php'>거래량</a></center></th>
...
<span style="font-size:30px;">빌라 매매 거래량 그래프</span>
<br>
...
<span style="font-size:30px;"><?=$area_main_name?> 빌라 전월세 거래량 그래프</span>
<br>
...
<br>
<br>
<span style="font-size:30px;"><?=$area_main_name?> 빌라 매매 거래량 상세</span>
...
<span style="font-size:30px;"><?=$area_main_name?> 빌라 전월세 거래량 상세</span>
<br>
<table>
    <thead>
    <tr>

...
<table>
    ...
    <tr>
      ...
      <th style="background-color:rgba(0, 0, 0, 0.3); width:20%; padding-top:15px; padding-bottom:10px;"><center><a style="font-size: 20px; color:white; text-decoration: none;" href='./apart_trend_apart_price_rent.php'>전세 가격지수</a></center></th>
...
<br>
<br>
<span style="font-size:30px;">최근3년 전국 아파트 실거래 전세가격지수 그래프</span>
<br>

...
<meta property="og:title" content="오늘집값 - 아파트전세 상세검색">
<meta property="og:description" content="오늘집값 - 아파트전세 정보를 상세히 검색 할 수 있습니다.">
...
if ($orderby=="" or $orderby=="latest_date"){
  ...
  $orderbytest = "order by cast(rent.last_price as decimal(10,2)) desc";
}elseif ($orderby=="max_all"){
  $orderbytest = "order by cast(rent.max_price as decimal(10,2)) desc";
}elseif ($orderby=="name"){
...
if ( $main == '1'){
  $main_text = "AND cast(rent.size as decimal(10,2)) > '49.99'";
}elseif ($main == ''){
  $main = "1";
  $main_text = "AND cast(rent.size as decimal(10,2)) > '49.99'";
}else{
...
$sql = "
      select
        ...
        from molit_max_min_rent_all rent LEFT join molit_max_min_all meme
...
<span style="font-size:30px; vertical-align: middle;"><b>아파트 전/월세 조회</b></span>
</center>
...
<h1>
<a href="./apart_today.php?area_main_name=<?=$area_main_name?>&insert_date=<?=$today?>&main=<?=$main?>"><?=$today?> 신규거래 조회하기</a>
<a style="float:right;" href='./apart_home.php?area_main_name=<?=$area_main_name?>&area_sub_name=<?=$area_sub_name?>&dong=<?=$dong?>&apart_name=<?=$apart_name?>&orderby=<?=$orderby?>&main=<?=$main?>'>전체 매매 조회하기</a>
</h1>
...
<span style="font-size:30px;"><b>시/군/구 : </b></span><select style="width:130px;font-size:30px;" name="sub" id="sub" onchange="apart_list(this)">
<!--
...
<br>
<span style="font-size:30px;"><b>아파트 : </b></span><select style="width:200px;font-size:30px;" name="apart_name" id="apart_name" onchange="apart_apart_list(this)">
<option value=''>선택</option>
<?php
...
<br>
<span style="font-size:20px;"><?php if ($area_main_name!="지역선택") {echo $area_main_name;} ?> <?php if ($area_main_name=="지역선택" or $area_sub_name=="세종특별자치시") { echo ""; } else {echo $area_sub_name;} ?> <?php echo $dong; ?> 전/월세 리스트(2017년 이후), 검색조건당 최대 300개 조회</span>
...
<table>
    ...
    <tr>
        ...
        <th style="font-size: 20px;"><b>최고가격<br>대비하락</b><br>(전세가율)</th>
        <th style="font-size: 20px;"><b>최근거래</b><br>(최근매매)</th>
        <th style="font-size: 20px;"><b>최고가격</b><br>(최고매매)</th>
        <th style="font-size: 20px;"><b>최저가격</b><br>(최저매매)</th>
    </tr>
    </thead>
    <tbody>

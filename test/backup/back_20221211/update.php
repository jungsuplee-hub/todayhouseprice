			...
			<div id="board_write">
                ...
                <input type="hidden" name="idx" value="<?=$bno?>" />
					<table class="table table-striped" style="text-align: center; border: 1px solid #ddddda">
						...
						-->
							<tr>
								<td style="vertical-align: middle; text-align: left;"><b>내용 : </b><textarea placeholder="글 내용" name="content" id="ucontent" style="width:93%; height: 200px;" required><?=$board['content']?></textarea></td>
							</tr>
						</tbody>
					</table>
					<br>

...
$sql_min_max = "
select
MIN(CAST(BUY_DOM_INDICES as DECIMAL(10,2)))-5 as temp_min,
MAX(CAST(BUY_DOM_INDICES as DECIMAL(10,2)))+5 as temp_max
from AptTradingMarketTrend
where 1=1
and LEVEL_NO = 0
and REGION_CD = 'A1000'
...
<table>
    <thead>
    <tr>
      <th style="background-color:rgba(0, 0, 0, 0.3); width:16%; padding-top:15px; padding-bottom:10px;"><center><a style="font-size: 20px; color:white; text-decoration: none;" href='./apart_trend_apart_meme.php'>매매 수급동향</a></center></th>
...
<br>
<br>
<span style="font-size:30px;">최근3년 전국 아파트 매매수급동향 그래프</span>
<br>

				...
				<div class="jumbotron" style="padding-top: 20px;">
					<form name="join"  method="post" action="reset_password_ok.php">
						...
						<div class="form-group">
							<input type="text" class="form-control" placeholder="이메일" name="id" id="id" maxlength="40">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<input type="email" class="form-control" placeholder="가입때 입력한 확인용이메일" name="email" id="email" maxlength="80">
						</div>

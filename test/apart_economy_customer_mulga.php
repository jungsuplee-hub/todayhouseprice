...
<table>
    ...
    <tr>
      ...
      <th style="background: #809EAD; width:16%; padding-top:15px; padding-bottom:10px;"><center><a style="font-size: 20px; color:white; text-decoration: none;" href='./list.php'>경제지표</a></center></th>
    </tr>
  </thead>
</table>
<table>
...
<span style="font-size:20px;">통계청 자료를 바탕으로 만들어진 데이터 입니다.
<br>
<br>

...
<title>오늘집값 - 오피스텔 전세 상세 조회</title>
<meta name="description" content="오피스텔 매매, 전세 실거래가를 확인해보세요. 당일 등록된 매매/전세정보를 확인하고 본인만의 즐겨찾기를 설정 할 수 있습니다.">
<meta property="og:type" content="website">
<meta property="og:title" content="오늘집값 - 오피스텔전세 상세검색">
<meta property="og:description" content="오늘집값 - 오피스텔전세 정보를 상세히 검색 할 수 있습니다.">
<meta property="og:image" content="./todayhouseprice2.png">
<meta property="og:url" content="http://todayhouseprice.com/apart_home_rent.php">
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2265060002718871"
     crossorigin="anonymous"></script>
<link rel="stylesheet" type="text/css" href="./todayhouseprice_rent.css">
</head>
...
if ($is_count) {
  $rs = mysqli_query($Conn, "select count(1) as cnt from molit_visit_count where ymd = '$today' and count_type = 'apart_home_rent';");
  $row = mysqli_fetch_assoc($rs);
  if($row['cnt']==0) {
    mysqli_query($Conn, "insert into molit_visit_count (ymd, count, count_type) values('$today',1,'apart_home_rent');");
  }else{
    mysqli_query($Conn, "update molit_visit_count set count = count + 1 where ymd = '$today' and count_type = 'apart_home_rent';");
  }
}
/////////////////////조회수//////////////////////////
...
<table>
    <thead>
    <tr>
      <th style="background: #FBE5D6; width:25%; font-size: 30px; padding-top:5px; padding-bottom:0px;"><center><a style="text-decoration: none;" href='../apart_home_rent.php?area_main_name=<?=$area_main_name?>&area_sub_name=<?=$area_sub_name?>&dong=<?=$dong?>&apart_name=<?=$apart_name?>&orderby=<?=$orderby?>'>아파트</a></center></th>
      <th style="background: #C0C0C0; width:25%; font-size: 30px; color:black; padding-top:5px; padding-bottom:0px;"><center>오피스텔</center></th>
      <th style="background: #E2F0D9; width:25%; font-size: 30px; padding-top:5px; padding-bottom:0px;"><center><a style="text-decoration: none;" href='../billa/apart_home_rent.php?area_main_name=<?=$area_main_name?>&area_sub_name=<?=$area_sub_name?>&dong=<?=$dong?>&apart_name=<?=$apart_name?>&orderby=<?=$orderby?>'>다세대주택(빌라)</a></center></th>
    </tr>
  </thead>
</table>
<table>
    ...
    <tr>
      ...
      <th style="background: #73685d; width:17%; padding-top:15px; padding-bottom:10px;"><center><a style="font-size: 20px; color:white; text-decoration: none;" href='./apart_home_rent.php?user_update=true'>전월세 상세조회</a></center></th>
...
<br>
<span style="font-size:20px;"><?php if ($area_main_name!="지역선택") {echo $area_main_name;} ?> <?php if ($area_main_name=="지역선택" or $area_sub_name=="세종특별자치시") { echo ""; } else {echo $area_sub_name;} ?> <?php echo $dong; ?> 전/월세 리스트(2017년 이후), 검색조건당 최대 100개 조회</span>

...
<meta property="og:title" content="오늘집값 - 오피스텔 전세 상세검색">
<meta property="og:description" content="오늘집값 - 오피스텔 전세 정보를 상세히 검색 할 수 있습니다.">
...
$sql = "
    ...
    FROM molit_info_rent_all_officetel
...
<table>
    <thead>
    <tr>
      <th style="background: #FBE5D6; width:25%; font-size: 30px; padding-top:5px; padding-bottom:0px;"><center><a style="text-decoration: none;" href='../apart_home_rent.php'>아파트</a></center></th>
      <th style="background: #C0C0C0; width:25%; font-size: 30px; color:black; padding-top:5px; padding-bottom:0px;"><center>오피스텔</center></th>
      <th style="background: #E2F0D9; width:25%; font-size: 30px; padding-top:5px; padding-bottom:0px;"><center><a style="text-decoration: none;" href='../billa/apart_home_rent.php'>다세대주택(빌라)</a></center></th>
    </tr>
  </thead>
</table>
<table>
...
<h2>
<a target="_blank" href='https://m.land.naver.com/search/result/<?php echo str_replace(' ','%20',$dong); ?><?php echo str_replace(' ','%20',$apart_name); ?>오피스텔'>네이버 부동산 바로가기</a>

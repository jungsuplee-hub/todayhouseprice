...
<table>
    <thead>
    <tr>
      <th style="background: #FBE5D6; width:25%; font-size: 30px; padding-top:5px; padding-bottom:0px;"><center><a style="text-decoration: none;" href='../apart_todayhouseprice_rank_one.php'>아파트</a></center></th>
...
<table>
    <thead>
    <tr>
      <th style="background-color:rgba(0, 0, 0, 0.3); width:25%; padding-top:15px; padding-bottom:10px;"><center><a style="font-size: 20px; color:white; text-decoration: none;" href='./apart_todayhouseprice_rank_one.php'>하락금액 Top 100</a></center></th>
...
<h1><?=$area_main_name?> 오피스텔 최고금액 대비 마지막거래가격 하락금액 Top 100</h1>
...
<table>
    ...
    <tr>
        ...
        <th style="font-size: 20px; width:37%;"><b>오피스텔명<br>지역</b></th>
        <th style="font-size: 20px; width:15%;"><b>전용면적</b></th>

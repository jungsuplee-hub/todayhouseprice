...
<meta property="og:title" content="오늘집값 - 오피스텔 매매 상세검색">
...
<table>
    ...
    <tr>
      ...
      <th style="background: #E2F0D9; width:25%; font-size: 30px; padding-top:5px; padding-bottom:0px;"><center><a style="text-decoration: none;" href='../billa/apart_home.php?area_main_name=<?=$area_main_name?>&area_sub_name=<?=$area_sub_name?>&dong=<?=$dong?>&apart_name=<?=$apart_name?>&orderby=<?=$orderby?>'>다세대주택(빌라)</a></center></th>
    </tr>
  </thead>
</table>
<table>

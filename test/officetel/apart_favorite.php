...
$sql = "
      ...
      from molit_max_min_all_officetel_group
...
$sql_rent = "
      select
        area_main_name,
      	...
      	ROUND((CAST(max_price as DECIMAL(10,5)) - CAST(last_price as DECIMAL(10,5))),2) as price_last,
      	ROUND(100-(CAST(last_price as DECIMAL(10,5))/CAST(max_price as DECIMAL(10,5)))*100,0) AS percent
      from molit_max_min_rent_all_officetel_group
...
<?php }?>
<br><span style="font-size:25px;"><b>거래 상세리스트 화면에서 하트모양을 클릭하시면 즐겨찾기 할 수 있습니다.</b></span><img style="vertical-align: middle;" width="25", height="25" src="./hearts_empty.png" ><img style="vertical-align: middle;" width="25", height="25" src="./hearts_full.png" >
<table>
    <thead>
    <tr>
      <th style="background: #FBE5D6; width:25%; font-size: 30px; padding-top:5px; padding-bottom:0px;"><center><a style="text-decoration: none;" href='../apart_favorite.php'>아파트</a></center></th>
...
<table>
    <thead>
    <tr>
        <th style="font-size: 20px;"><b>주택명</b></th>
...
<table>
    <thead>
    <tr>
        <th style="font-size: 20px; background: #809EAD;"><b>주택명</b></th>

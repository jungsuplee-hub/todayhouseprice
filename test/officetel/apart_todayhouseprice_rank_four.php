...
and (min_price_date like '2022%' or min_price_date like '2023%' or min_price_date like '2024%')
order by CAST(min_price as DECIMAL(10,5))
limit 100;
      ";
...
<table>
    <thead>
    <tr>
      <th style="background: #FBE5D6; width:25%; font-size: 30px; padding-top:5px; padding-bottom:0px;"><center><a style="text-decoration: none;" href='../apart_todayhouseprice_rank_four.php'>아파트</a></center></th>
      <th style="background: #C0C0C0; width:25%; font-size: 30px; color:black; padding-top:5px; padding-bottom:0px;"><center>오피스텔</center></th>
      <th style="background: #E2F0D9; width:25%; font-size: 30px; padding-top:5px; padding-bottom:0px;"><center><a style="text-decoration: none;" href='../billa/apart_todayhouseprice_rank_four.php'>다세대주택(빌라)</a></center></th>
    </tr>
  </thead>
</table>
<table>
...
<table>
    ...
    <tr>
      ...
      <th style="background-color:rgba(0, 0, 0, 0.3); width:25%; padding-top:15px; padding-bottom:10px;"><center><a style="font-size: 20px; color:white; text-decoration: none;" href='./apart_todayhouseprice_rank_four.php'>가격 하위 Top 100</a></center></th>
    </tr>
  </thead>
</table>
<br>
...
<table>
    ...
    <tr>
        ...
        <th style="font-size: 20px; width:18%;"><b>최저가격</b></th>
        <th style="font-size: 20px; width:18%;"><b>거래일자</b></th>
    ...
    <tbody>
      ...
      <tr>
          ...
          <td style="font-size: 20px;"><b><?=$row['min_price']?>억</b></td>
          <td style="font-size: 20px;"><b><?=$row['min_price_date']?></b></td>
      </tr>
      <?php } ?>
    </tbody>
</table>

...
replace(replace(apart_name,' ',''),'''','') as apart_name,
...
TYPE,
ROUND(CAST(last_price as DECIMAL(10,5)),2) as last_price,
ROUND(CAST(max_price as DECIMAL(10,5)),2) as max_price,
...
<span style="font-size:25px; vertical-align: middle; font-family: nanumpen;">&nbsp;&nbsp;오늘집값 실거래(<?=$today?>)</span>
...
for (var i = 0; i < areaArr.length; i++) {
 ...
 var infoWindow = new naver.maps.InfoWindow({
     content: 
     '<div style="width:200px; padding:10px;"><center><span style="font-size:20px;"><b><a href="./apart.php?area_main_name='+areaArr[i].area_main_name+'&area_sub_name='+areaArr[i].area_sub_name+'&dong='+areaArr[i].dong+'&apart_name='+areaArr[i].apart_name+'&size='+areaArr[i].size+'">' 
     + areaArr[i].apart_name+'</a></b></span></center>'+
     '<table>'+
        '<thead>'+
            '<tr>'+

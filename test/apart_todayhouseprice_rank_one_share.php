...
<title>오늘집값 - 아파트 랭킹(최고금액대비 하락가격 Top 100)</title>
...
order by (CAST(max_price as DECIMAL(10,5)) - CAST(last_price as DECIMAL(10,5))) desc
limit 100;
      ";
...
<?php
  if(!$userid){
?>
<a style="font-size:25px;" href="./login.php"><b>로그인</b></a><span style="font-size:25px;"><b> <-- 로그인 으로 즐겨찾기 기능사용</b></span>  <a style="font-size:25px;" href='./info.php'>(텔레그램으로 매일 알림받기)</a>
<?php
  }else if($userid){
...
<table>
    ...
    <tr>
      ...
      <th style="background: #DEEBF7; width:25%; font-size: 30px; padding-top:5px; padding-bottom:0px;"><center><a style="text-decoration: none;" href='../officetel/apart_todayhouseprice_rank_one.php'>오피스텔</a></center></th>
      <th style="background: #E2F0D9; width:25%; font-size: 30px; padding-top:5px; padding-bottom:0px;"><center><a style="text-decoration: none;" href='../billa/apart_todayhouseprice_rank_one.php'>다세대주택(빌라)</a></center></th>
    </tr>
  </thead>
</table>
<table>
...
<table>
    <thead>
    <tr>
      <th style="background-color:rgba(0, 0, 0, 0.3); width:33%; padding-top:15px; padding-bottom:10px;"><center><a style="font-size: 20px; color:white; text-decoration: none;" href='./apart_todayhouseprice_rank_one.php'>하락금액 Top 100</a></center></th>
      <th style="background-color:rgba(255, 255, 255, 0.8); width:33%; padding-top:15px; padding-bottom:10px;"><center><a style="font-size: 20px; color:black; text-decoration: none;" href='./apart_todayhouseprice_rank_two.php'>하락률 Top 100</a></center></th>
      <th style="background-color:rgba(255, 255, 255, 0.8); width:33%; padding-top:15px; padding-bottom:10px;"><center><a style="font-size: 20px; color:black; text-decoration: none;" href='./apart_todayhouseprice_rank_three.php'>가격 Top 100</a></center></th>
    </tr>
  </thead>
</table>
<br>
...
function check1(country){
  location.href = "./apart_todayhouseprice_rank_one.php?area_main_name=<?=$area_main_name?>&size1="+document.getElementById("size1").checked+"&size2="+document.getElementById("size2").checked+"&size3="+document.getElementById("size3").checked+"&size4="+document.getElementById("size4").checked;
}
...
<h1><?=$area_main_name?> 아파트 최고금액 대비 마지막거래가격 하락금액 Top 100</h1>
<span style="font-size: 20px;">*참고<br>. 거래취소 내용이 반영되지 않은 케이스가 일부 있을 수 있습니다.<br>. 직거래 가격이 포함되어 있어 조금 튀는 데이터가 있을 수 있습니다.<br>. 최고가격은 2020년 이후, <br>&nbsp;&nbsp;마지막거래가격은 2021년 이후 데이터를 기준으로 하였습니다.</span>
<br><br>
...
<table>
    ...
    <tr>
        ...
        <th style="font-size: 20px; width:37%;"><b>아파트명<br>지역</b></th>
        <th style="font-size: 20px; width:15%;"><b>전용면적</b><br>공급면적<br>(공급형평)</th>
...
function apart_list(e) {
  <?php echo "window.location.replace('./apart_todayhouseprice_rank_one.php?'+'area_main_name='+document.getElementById('main').value+'&size1=$size1'+'&size2=$size2'+'&size3=$size3'+'&size4=$size4');"?>
}
</script>

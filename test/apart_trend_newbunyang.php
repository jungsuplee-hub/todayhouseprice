...
<table>
    ...
    <tr>
      ...
      <th style="background-color:rgba(0, 0, 0, 0.3); width:20%; padding-top:15px; padding-bottom:10px;"><center><a style="font-size: 20px; color:white; text-decoration: none;" href='./apart_trend_newbunyang.php'>신규분양</a></center></th>
...
<br>
<br>
<span style="font-size:30px;">최근4년 전국 아파트 신규분양 그래프</span>
<br>

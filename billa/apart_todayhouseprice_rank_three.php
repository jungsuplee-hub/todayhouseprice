...
apart_name,
size,
ROUND(CAST(last_price as DECIMAL(10,5)) - CAST(last_price as DECIMAL(10,5)),2) as diff_price,
ROUND(100-(CAST(last_price as DECIMAL(10,5))/CAST(last_price as DECIMAL(10,5))*100) ,2) as diff_rate,
last_price,
last_price_date
...
order by CAST(last_price as DECIMAL(10,5)) desc
limit 100;
      ";

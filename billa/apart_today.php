...
$sql = "
      ...
      from molit_today_update_billa today LEFT join molit_max_min_rent_all_billa_group rent
...
$sql_rent = "
      ...
      from molit_today_update_rent_billa today LEFT join molit_max_min_all_billa_group meme
...
$sql_status = "
  SELECT
      (SELECT COUNT(1) from molit_today_update_billa today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) and status is not null) AS total,
      IFNULL((SELECT COUNT(1) from molit_today_update_billa today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='신고가' and status is not null GROUP BY STATUS),0) AS upup,
      IFNULL((SELECT COUNT(1) from molit_today_update_billa today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='상승' and status is not null GROUP BY STATUS),0) AS up,
      IFNULL((SELECT COUNT(1) from molit_today_update_billa today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='동일' and status is not null GROUP BY STATUS),0) AS same,
      IFNULL((SELECT COUNT(1) from molit_today_update_billa today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='하락' and status is not null GROUP BY STATUS),0) AS down,
      IFNULL((SELECT COUNT(1) from molit_today_update_billa today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='신저가' and status is not null GROUP BY STATUS),0) AS downdown,
      IFNULL((SELECT COUNT(1) from molit_today_update_billa today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='신규' and status is not null GROUP BY STATUS),0) AS new,
      (SELECT SUM(ROUND((CAST(price as DECIMAL(10,5)) - CAST(last_price as DECIMAL(10,5))),2))from molit_today_update_billa today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) and status is not null AND STATUS IN ('신고가','상승')) AS up_price,
      (SELECT SUM(ROUND((CAST(last_price as DECIMAL(10,5)) - CAST(price as DECIMAL(10,5))),2))from molit_today_update_billa today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) and status is not null AND STATUS IN ('신저가','하락')) AS down_price
      FROM DUAL;
";

$sql_status_rent = "
  SELECT
      (SELECT COUNT(1) from molit_today_update_rent_billa today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) and status is not null) AS total,
      IFNULL((SELECT COUNT(1) from molit_today_update_rent_billa today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='신고가' and status is not null GROUP BY STATUS),0) AS upup,
      IFNULL((SELECT COUNT(1) from molit_today_update_rent_billa today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='상승' and status is not null GROUP BY STATUS),0) AS up,
      IFNULL((SELECT COUNT(1) from molit_today_update_rent_billa today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='동일' and status is not null GROUP BY STATUS),0) AS same,
      IFNULL((SELECT COUNT(1) from molit_today_update_rent_billa today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='하락' and status is not null GROUP BY STATUS),0) AS down,
      IFNULL((SELECT COUNT(1) from molit_today_update_rent_billa today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='신저가' and status is not null GROUP BY STATUS),0) AS downdown,
      IFNULL((SELECT COUNT(1) from molit_today_update_rent_billa today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='신규' and status is not null GROUP BY STATUS),0) AS new,
      (SELECT SUM(ROUND((CAST(rent_price as DECIMAL(10,5)) - CAST(last_price as DECIMAL(10,5))),2))from molit_today_update_rent_billa today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) and status is not null AND STATUS IN ('신고가','상승')) AS up_price,
      (SELECT SUM(ROUND((CAST(last_price as DECIMAL(10,5)) - CAST(rent_price as DECIMAL(10,5))),2))from molit_today_update_rent_billa today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) and status is not null AND STATUS IN ('신저가','하락')) AS down_price
      FROM DUAL;
";
...
<?php if($isMobile=='Y'){?>
<input id="search" type="search" size="30" style="font-size:30px; border-radius: 15px; border-color:#73685d; outline: none; padding-bottom: 5px; padding-top: 8px; padding-left: 20px;" placeholder="빌리명 검색,  최대 10개" onkeyup="showResult(this.value)" autofocus autocomplete="off">
<?php }else{?>
<input id="search" type="search" size="40" style="font-size:30px; border-radius: 15px; border-color:#73685d; outline: none; padding-bottom: 5px; padding-top: 8px; padding-left: 20px;" placeholder="빌리명 검색,  최대 10개" onkeyup="showResult(this.value)" autofocus autocomplete="off">
<?php }?>
</form>
</center>
<br>
...
$rs_sub = mysqli_query($Conn, "
            ...
            FROM
            (
              select replace(replace(area_name, concat(area_main_name,' '),''),' ','') as area_sub_name from molit_today_update_billa today where $area_main_name_text and insert_date = '$insert_date' and (1!=1 $size1_text $size2_text $size3_text $size4_text) and status is not null group by area_main_name, area_name
              UNION all
              select replace(replace(area_name, concat(area_main_name,' '),''),' ','') as area_sub_name from molit_today_update_billa today where $area_main_name_text and insert_date = '$insert_date' and (1!=1 $size1_text $size2_text $size3_text $size4_text) and status is not null group by area_main_name, area_name
            ) AS a
...
<table>
    ...
    <tr>
        <?php if($isMobile == "Y") { ?>
            <th style="font-size: 20px; background: #FF0000; width:34%;"><b>빌라명</b><br>거래일자</b></th>
            ...
            <th style="font-size: 20px; background: #FF0000; width:17%;"><b>최고대비<br>하락/<br>상승률</b></th>
            <th style="font-size: 20px; background: #FF0000; width:13%;"><b>최근가격<br>최고가격</b></th>
        <?php }else { ?>
            <th style="font-size: 20px; background: #FF0000; width:35%;"><b>빌라명</b><br>거래일자</b></th>
            <th style="font-size: 20px; background: #FF0000; width:14%;"><b>전용면적</b><br>층<br>거래유형<br>(계약갱신)</b></th>
...
<table>
    ...
    <tbody>
      ...
      <tr>
          ...
          <?php if($isMobile == "Y") { ?>
            <td style="font-size: 20px;"><b><?=$row['last_price']?>억</b><br>(<?=$row['last_price_date']?>)<br><b><?=$row['max_price']?>억</b><br>(<?=$row['max_price_date']?>)</td>
          <?php }else { ?>
...
<table>
    ...
    <tr>
    <?php if($isMobile == "Y") { ?>
        <th style="font-size: 20px; background: #809EAD; width:34%;"><b>빌라명</b><br>거래일자</b></th>
        ...
        <th style="font-size: 20px; background: #809EAD; width:17%;"><b>최고대비<br>하락/<br>상승률</b></th>
        <th style="font-size: 20px; background: #809EAD; width:17%;"><b>최근가격<br>최고가격</b></th>
    <?php }else { ?>
        <th style="font-size: 20px; background: #809EAD; width:35%;"><b>빌라명</b><br>거래일자</b></th>
        <th style="font-size: 20px; background: #809EAD; width:14%;"><b>전용면적</b><br>층<br>거래유형</b></th>

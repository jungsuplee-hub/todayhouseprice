...
if ($insert_date == ""){
  if($this_hour=="00" || $this_hour=="01" || $this_hour=="02" || $this_hour=="03" || $this_hour=="04" || $this_hour=="05" || $this_hour=="06"){
...
$sql = "
      ...
      from molit_today_update_officetel today LEFT join molit_max_min_rent_all_officetel_group rent
...
$sql_rent = "
      ...
      from molit_today_update_rent_officetel today LEFT join molit_max_min_all_officetel_group meme
...
$sql_status = "
  SELECT
      (SELECT COUNT(1) from molit_today_update_officetel today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) and status is not null) AS total,
      IFNULL((SELECT COUNT(1) from molit_today_update_officetel today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='신고가' and status is not null GROUP BY STATUS),0) AS upup,
      IFNULL((SELECT COUNT(1) from molit_today_update_officetel today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='상승' and status is not null GROUP BY STATUS),0) AS up,
      IFNULL((SELECT COUNT(1) from molit_today_update_officetel today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='동일' and status is not null GROUP BY STATUS),0) AS same,
      IFNULL((SELECT COUNT(1) from molit_today_update_officetel today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='하락' and status is not null GROUP BY STATUS),0) AS down,
      IFNULL((SELECT COUNT(1) from molit_today_update_officetel today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='신저가' and status is not null GROUP BY STATUS),0) AS downdown,
      IFNULL((SELECT COUNT(1) from molit_today_update_officetel today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='신규' and status is not null GROUP BY STATUS),0) AS new,
      (SELECT SUM(ROUND((CAST(price as DECIMAL(10,5)) - CAST(last_price as DECIMAL(10,5))),2))from molit_today_update_officetel today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) and status is not null AND STATUS IN ('신고가','상승')) AS up_price,
      (SELECT SUM(ROUND((CAST(last_price as DECIMAL(10,5)) - CAST(price as DECIMAL(10,5))),2))from molit_today_update_officetel today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) and status is not null AND STATUS IN ('신저가','하락')) AS down_price
      FROM DUAL;
";

$sql_status_rent = "
  SELECT
      (SELECT COUNT(1) from molit_today_update_rent_officetel today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) and status is not null) AS total,
      IFNULL((SELECT COUNT(1) from molit_today_update_rent_officetel today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='신고가' and status is not null GROUP BY STATUS),0) AS upup,
      IFNULL((SELECT COUNT(1) from molit_today_update_rent_officetel today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='상승' and status is not null GROUP BY STATUS),0) AS up,
      IFNULL((SELECT COUNT(1) from molit_today_update_rent_officetel today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='동일' and status is not null GROUP BY STATUS),0) AS same,
      IFNULL((SELECT COUNT(1) from molit_today_update_rent_officetel today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='하락' and status is not null GROUP BY STATUS),0) AS down,
      IFNULL((SELECT COUNT(1) from molit_today_update_rent_officetel today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='신저가' and status is not null GROUP BY STATUS),0) AS downdown,
      IFNULL((SELECT COUNT(1) from molit_today_update_rent_officetel today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) AND STATUS ='신규' and status is not null GROUP BY STATUS),0) AS new,
      (SELECT SUM(ROUND((CAST(rent_price as DECIMAL(10,5)) - CAST(last_price as DECIMAL(10,5))),2))from molit_today_update_rent_officetel today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) and status is not null AND STATUS IN ('신고가','상승')) AS up_price,
      (SELECT SUM(ROUND((CAST(last_price as DECIMAL(10,5)) - CAST(rent_price as DECIMAL(10,5))),2))from molit_today_update_rent_officetel today WHERE insert_Date = '$insert_date' AND $area_main_name_text $area_sub_name_text and (1!=1 $size1_text $size2_text $size3_text $size4_text) and status is not null AND STATUS IN ('신저가','하락')) AS down_price
      FROM DUAL;
";
...
<?php if($isMobile=='Y'){?>
<input id="search" type="search" size="30" style="font-size:30px; border-radius: 15px; border-color:#73685d; outline: none; padding-bottom: 5px; padding-top: 8px; padding-left: 20px;" placeholder="오피스텔명 검색,  최대 10개" onkeyup="showResult(this.value)" autofocus autocomplete="off">
<?php }else{?>
<input id="search" type="search" size="40" style="font-size:30px; border-radius: 15px; border-color:#73685d; outline: none; padding-bottom: 5px; padding-top: 8px; padding-left: 20px;" placeholder="오피스텔명 검색,  최대 10개" onkeyup="showResult(this.value)" autofocus autocomplete="off">
...
$rs_sub = mysqli_query($Conn, "
            ...
            FROM
            (
              select replace(replace(area_name, concat(area_main_name,' '),''),' ','') as area_sub_name from molit_today_update_officetel today where $area_main_name_text and insert_date = '$insert_date' and (1!=1 $size1_text $size2_text $size3_text $size4_text) and status is not null group by area_main_name, area_name
              UNION all
              select replace(replace(area_name, concat(area_main_name,' '),''),' ','') as area_sub_name from molit_today_update_officetel today where $area_main_name_text and insert_date = '$insert_date' and (1!=1 $size1_text $size2_text $size3_text $size4_text) and status is not null group by area_main_name, area_name
            ) AS a
...
<table>
    ...
    <tr>
    <?php if($isMobile == "Y") { ?>
        <th style="font-size: 20px; background: #FF0000; width:24%;"><b>오피스텔명<br>거래일자</b></th>
        <th style="font-size: 20px; background: #FF0000; width:14%;"><b>전용면적</b><br>층<br>거래유형<br>(계약갱신)</b></th>
        <th style="font-size: 20px; background: #FF0000; width:18%;"><b>신규가격<br>가격변동<br>변동률</b></th>
        <th style="font-size: 20px; background: #FF0000; width:17%;"><b>최고대비</b><br>하락/상승률</b></th>
        <th style="font-size: 20px; background: #FF0000; width:17%;"><b>최근가격<br><br>최고가격</b></th>
    <?php }else { ?>
        <th style="font-size: 20px; background: #FF0000; width:35%;"><b>오피스텔명<br>거래일자</b></th>
        <th style="font-size: 20px; background: #FF0000; width:14%;"><b>전용면적</b><br>층<br>거래유형<br>(계약갱신)</b></th>
        <th style="font-size: 20px; background: #FF0000; width:12%;"><b>신규가격<br>가격변동<br>변동률</b></th>
        <th style="font-size: 20px; background: #FF0000; width:13%;"><b>최고대비</b><br>하락/상승률</b></th>
    ...
    <tbody>
      ...
      <tr>
          ...
          ?>
          <td style="background-color:rgba(150, 75, 0, 0.2); font-size: 20px;"><b><?=$row_favorite['price_max']?>억<br><?php if($row_favorite['max_percent']>=30){ echo "<span style='color:red;'>최고가<br>대비<br>"; echo $row_favorite['max_percent']; echo "%<br>하락</span>";} elseif($row_favorite['max_percent']<0){ echo "<span style='color:green;'>최고가<br>대비<br>"; echo abs($row_favorite['max_percent']); echo "%<br>상승</span>";} else{ echo "최고가<br>대비<br>"; echo $row_favorite['max_percent']; echo "%<br>하락";} ?></b></td>
          <?php if($isMobile == "Y") { ?>
            <td style="background-color:rgba(150, 75, 0, 0.2); font-size: 20px;"><b><?=$row_favorite['last_price']?>억</b><br>(<?=$row_favorite['last_price_date']?>)<br><b><?=$row_favorite['max_price']?>억</b><br>(<?=$row_favorite['max_price_date']?>)</td>
          <?php }else { ?>
            <td style="background-color:rgba(150, 75, 0, 0.2); font-size: 20px;"><b><?=$row_favorite['last_price']?>억</b><br><?=$row_favorite['last_price_date']?><br>(<?=$row_favorite['rent_last_price']?>억)</td>
            <td style="background-color:rgba(150, 75, 0, 0.2); font-size: 20px;"><b><?=$row_favorite['max_price']?>억</b><br><?=$row_favorite['max_price_date']?><br>(<?=$row_favorite['rent_max_price']?>억)</td>
          <?php } ?>
      </tr>
      <?php } ?>
    </tbody>
    <tbody>
      ...
      <tr>
          ...
          ?>
          <td style="background-color:rgba(80, 188, 223, 0.2); font-size: 20px; width:13%;"><b><?=$row_favorite_rent['price_max']?>억<br><?php if($row_favorite_rent['max_percent']>=30){ echo "<span style='color:red;'>최고가<br>대비<br>"; echo $row_favorite_rent['max_percent']; echo "%<br>하락</span>";} elseif($row_favorite_rent['max_percent']<0){ echo "<span style='color:green;'>최고가<br>대비<br>"; echo abs($row_favorite_rent['max_percent']); echo "%<br>상승</span>";} else{ echo "최고가<br>대비<br>"; echo $row_favorite_rent['max_percent']; echo "%<br>하락";} ?></b></td>
          <?php if($isMobile == "Y") { ?>
            <td style="background-color:rgba(80, 188, 223, 0.2); font-size: 20px; width:13%;"><b><?=$row_favorite_rent['last_price']?>억</b><br>(<?=$row_favorite_rent['last_price_date']?>)<br><b><?=$row_favorite_rent['max_price']?>억</b><br>(<?=$row_favorite_rent['max_price_date']?>)</td>
          <?php }else { ?>
...
<table>
    ...
    <tr>
    <?php if($isMobile == "Y") { ?>
        <th style="font-size: 20px; width:34%;"><b>오피스텔명<br>거래일자</b></th>
        <th style="font-size: 20px; width:14%;"><b>전용면적</b><br>층<br>거래유형</b></th>
        <th style="font-size: 20px; width:18%;"><b>신규가격<br>가격변동<br>변동률</b></th>
        <th style="font-size: 20px; width:17%;"><b>최고대비<br>하락/상승률</b></th>
        <th style="font-size: 20px; width:17%;"><b>최근가격<br>최고가격</b></th>
    <?php }else { ?>
        <th style="font-size: 20px; width:35%;"><b>오피스텔명<br>거래일자</b></th>
        <th style="font-size: 20px; width:14%;"><b>전용면적</b><br>층<br>거래유형</b></th>
    ...
    <tbody>
      ...
      <tr>
          ...
          <?php if($isMobile == "Y") { ?>
            <td style="font-size: 20px; width:13%;"><b><?=$row['last_price']?>억</b><br>(<?=$row['last_price_date']?>)<br><b><?=$row['max_price']?>억</b><br>(<?=$row['max_price_date']?>)</td>
          <?php }else{ ?>
...
<table>
    ...
    <tr>
    <?php if($isMobile == "Y") { ?>
        <th style="font-size: 20px; background: #809EAD; width:34%;"><b>오피스텔명<br>거래일자</b></th>
        <th style="font-size: 20px; background: #809EAD; width:14%;"><b>전용면적</b><br>층<br>거래유형</b></th>
        <th style="font-size: 20px; background: #809EAD; width:18%;"><b>신규가격<br>가격변동<br>변동률</b></th>
        <th style="font-size: 20px; background: #809EAD; width:17%;"><b>최고대비<br>하락/상승률</b></th>
        <th style="font-size: 20px; background: #809EAD; width:17%;"><b>최근가격<br>최고가격<br></th>
    <?php }else { ?>
        <th style="font-size: 20px; background: #809EAD; width:35%;"><b>오피스텔명<br>거래일자</b></th>
        <th style="font-size: 20px; background: #809EAD; width:14%;"><b>전용면적</b><br>층<br>거래유형</b></th>
    ...
    <tbody>
      ...
      <tr>
          ...
          <?php if($isMobile == "Y") { ?>
            <td style="font-size: 20px;"><b><?=$row_rent['last_price']?>억</b><br>(<?=$row_rent['last_price_date']?>)<br><b><?=$row_rent['max_price']?>억</b><br>(<?=$row_rent['max_price_date']?>)</td>
          <?php }else { ?>
            <td style="font-size: 20px;"><b><?=$row_rent['last_price']?>억</b><br><?=$row_rent['last_price_date']?><br>(<?=$row_rent['meme_last_price']?>억)</td>
            <td style="font-size: 20px;"><b><?=$row_rent['max_price']?>억</b><br><?=$row_rent['max_price_date']?><br>(<?=$row_rent['meme_max_price']?>억)</td>
          <?php } ?>
      </tr>
      <?php } ?>
    </tbody>

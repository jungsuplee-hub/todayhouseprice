...
<table>
    <thead>
    <tr>
        <th style="font-size: 20px; width:50%;">단지명<br>시행사<br>공급위치</b></th>
    ...
    <tbody>
      ...
      <tr>
        <?php if($row['HMPG_ADRES']=='null'){ ?>
          <td style="font-size: 20px; width:50%;"><b><?=$row['HOUSE_NM']?></b><br><span style="font-size: 15px;"><?=$row['BSNS_MBY_NM']?><br><?=$row['HSSPLY_ADRES']?></span></td>
        <?php }else{ ?>
          <td style="font-size: 20px; width:50%;"><b><a href='<?=$row[HMPG_ADRES]?>' target='_blank'><?=$row['HOUSE_NM']?></b></a><br><span style="font-size: 15px;"><?=$row['BSNS_MBY_NM']?><br><?=$row['HSSPLY_ADRES']?></span></td>
        <?php } ?>
          <td style="font-size: 20px; width:20%;"><b><?=$row['RCRIT_PBLANC_DE']?></b></td>
          <td style="font-size: 20px; width:20%;"><b><?=$row['SUBSCRPT_RCEPT_BGNDE']?><br><?=$row['SUBSCRPT_RCEPT_ENDDE']?><br>(<?=$row['MVN_PREARNGE_YM']?>)</b></td>

...
<h1><?php echo $area_main_name; ?> <?php echo $dong; ?> <?php echo $apart_name; ?><br>전용면적 : <?php echo $size; ?>㎡ 실거래 리스트(2017년 이후)</h1>
...
<iframe id="inlineFrameExample"
    ...
    width="100%"
    height="500"
    src="https://m.map.kakao.com/actions/searchView?q=<?php echo str_replace(' ','%20',$dong); ?><?php echo str_replace(' ','%20',$apart_name); ?>아파트&wxEnc=LQMSQP&wyEnc=QNLURRS&lvl=4#!/all/map/place">
</iframe>

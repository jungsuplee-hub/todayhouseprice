...
?>
<center><span style="font-size:30px;"><b>아파트 전/월세 상세조회</b></span><a style="font-size:15px;" href='http://1.239.38.238:8880/info.php'>(텔레그램알림받기)</a></center>
<br>
<span style="font-size:30px;"><?php echo $area_main_name; ?> <?php echo $dong; ?> <?php echo $apart_name; ?>(건축년도 : <?php echo $build_year; ?>년) <br>전용면적 : <?php if( $all_area=="Y") { echo "전체";} else {echo $size; echo "㎡";}?>, 전/월세 리스트(2017년 이후)</span>
<h1>
<a href='http://1.239.38.238:8880/apart_rent.php?area_main_name=<?php echo $area_main_name; ?>&apart_name=<?php echo $apart_name; ?>&size=<?php echo $size; ?>&dong=<?php echo $dong; ?>&all_area=Y'>전체면적보기</a>
<a style="float:right;" href='http://1.239.38.238:8880/apart.php?area_main_name=<?php echo $area_main_name; ?>&apart_name=<?php echo $apart_name; ?>&size=<?php echo $size; ?>&dong=<?php echo $dong; ?>&all_area=<?php echo $all_area; ?>'>해당 아파트 매매 정보 보기</a>
<h1>
<h2>
...
<table>
    ...
    <tbody>
      ...
      <tr>
          <td <?php if ($row['month_price']!="0") {echo "style='color: skyblue;'";} ?>><?=$row['apart_name']?></td>
          <td <?php if ($row['month_price']!="0") {echo "style='color: skyblue;'";} ?>><?=$row['yearmonthday']?></td>
          <td <?php if ($row['month_price']!="0") {echo "style='color: skyblue;'";} ?>><?=$row['size']?>㎡</td>
          <td <?php if ($row['month_price']!="0") {echo "style='color: skyblue;'";} ?>><?=$row['stair']?>층</td>
          <td <?php if ($row['month_price']!="0") {echo "style='color: skyblue;'";} ?>><?=$row['price']?>억</td>
          <td <?php if ($row['month_price']!="0") {echo "style='color: skyblue;'";} ?>><?php if ($row['month_price']!="0") {echo $row['month_price']; echo "만원";} ?></td>
          <td <?php if ($row['month_price']!="0") {echo "style='color: skyblue;'";} ?>><?php if ($row['month_price']!="0") {echo "월세";}else {echo "전세";} ?></td>
      </tr>
      <?php } ?>
    </tbody>
</table>

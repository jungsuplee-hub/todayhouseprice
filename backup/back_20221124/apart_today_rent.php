...
?>
<span style="font-size:30px;"><center><b>전국 아파트 실거래가 조회</b></center></span>
<center>(오전7시 업데이트)</center><br>  
<h1><a href='http://1.239.38.238:8880/apart_home.php'>부동산 실거래 조회 홈페이지</a></h1>
<h1>
...
<?php echo $insert_date; ?> 신규 실거래 리스트(2017년 이후) <br>
...
<h2>총 <?php echo $row_status['total']; ?>건, 총 상승금액 : <?php echo $row_status['up_price']; ?>억, 총 하락금액 : <?php echo $row_status['down_price']; ?>억<br>(신고가 <?php echo $row_status['upup']; ?>건, 상승 <?php echo $row_status['up']; ?>건, 동일 <?php echo $row_status['same']; ?>건, 하락 <?php echo $row_status['down']; ?>건, 신저가 <?php echo $row_status['downdown']; ?>건, 신규 <?php echo $row_status['new']; ?>건)</h2>
...
<table>
    ...
    <tbody>
      ...
      <tr>
          <td style="font-size: 20px;"><a href='http://1.239.38.238:8880/apart.php?area_main_name=<?=$row[area_main_name]?>&apart_name=<?=$row[apart_name]?>&size=<?=$row[size]?>&dong=<?=$row[doing]?>&all_area=N'><b><?=$row['yearmonthday']?></b><br><b><?=$row['area_name']?></b><br><b><?=$row['apart_name']?></b></td>

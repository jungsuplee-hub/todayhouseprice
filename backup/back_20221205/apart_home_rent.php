...
if ($orderby=="" or $orderby=="latest_date"){
  $orderby = "latest_date";
  $orderbytest = "order by date_format(last_price_date,'%Y-%m-%d') desc";
}elseif ($orderby=="max_lastest"){
  $orderbytest = "order by cast(last_price as decimal(10,2)) desc";
}elseif ($orderby=="max_all"){
  $orderbytest = "order by cast(max_price as decimal(10,2)) desc";
}elseif ($orderby=="name"){
  $orderbytest = "order by apart_name, size";
}elseif ($orderby=="diff_price"){
  $orderbytest = "and last_price != '0' order by ROUND((CAST(max_price as DECIMAL(10,5)) - CAST(last_price as DECIMAL(10,5))),2) desc";
}

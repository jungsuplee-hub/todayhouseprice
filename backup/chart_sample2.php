    ...
    chartDrow : function(){
      ...
      data.addRows([
        <?php
                ...
                $sql="SELECT YEAR AS YY, LPAD(MONTH,'2','0') AS MM, LPAD(DAY,'2','0') AS DD, cast(price as unsigned) AS server_cnt from molit_info_all  WHERE areacode = '11620'  AND apart_name = '관악파크푸르지오'  AND size = '84.99'  ORDER BY YEAR, MONTH, DAY";
